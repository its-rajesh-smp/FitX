...
Workout planDay names must be descriptive (e.g., Chest Workout, Upper Body Workout).
Never use generic numbered planDay.
...
2. Never use planDay names like "Full Body Beginner Workout 1", "Sunday Rest Day", "Chest Workout 3", "Day 1", "Lower Body Beginner Workout 3" etc...
