...
export const getPlanTool = tool({
  name: "getPlan",
  description:
    "Get the user's current workout plan with workout days sorted by scheduled date and exercises sorted by order. Always call this before any plan modification.",
  parameters: z.object({}),
