  ...
  return (
    <main className="grid min-h-screen lg:grid-cols-2">
      <section className="relative hidden overflow-hidden bg-primary p-12 text-white lg:flex lg:flex-col">
        <Link to="/plan" className="flex items-center gap-3 text-xl font-extrabold"><span className="flex size-10 items-center justify-center rounded-xl bg-white/15"><Dumbbell /></span>FitAI</Link>
      ...
      <section className="flex items-center justify-center bg-canvas px-4 py-10">
        <div className="w-full max-w-md">
          <Link to="/plan" className="mb-10 flex items-center justify-center gap-2 text-xl font-extrabold lg:hidden"><span className="flex size-9 items-center justify-center rounded-lg bg-primary text-white"><Dumbbell className="size-5" /></span>FitAI</Link>
          {children}
        </div>
      </section>
    </main>
